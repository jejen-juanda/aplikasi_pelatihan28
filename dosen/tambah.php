...
<body>
    ...
    <form method="post" action="#">
        ...
        <p><label>Kode Dosen: </label><input name="kode_dosen" type="number"></p>
        <p><label>Nama Dosen</label> : </label><input name="nama_dosen" type="text"></p>
        <p><label>Alamat: </label><input name="alamat_dosen" type="text"></p>
